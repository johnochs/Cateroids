(function () {
	...
	var Asteroid = Asteroids.Asteroid = function (options) {
		...
		this.img = new Image();
		this.img.src = "./Doge.png"
		this.leftEye = new Asteroids.Eye({ pos: options.pos, ship: options.game.ship, radius: options.radius / 5 });
		this.rightEye = new Asteroids.Eye({ pos: options.pos, ship: options.game.ship, radius: options.radius / 5 });
		
		Asteroids.MovingObject.call(this, options);
	};
	
	Asteroid.COLOR = "#00FF00"
	Asteroid.RADIUS = function () { return (15 + 35 * Math.random()); };
