(function () {
	...
	var Game = Asteroids.Game = function () {
		...
		this.addEyes();
		this.bullets = [];
		// this.shipKiller = new Asteroids.shipKiller({ pos: [400, 300], radius: 25, game: this })
	};
	...
	Game.prototype.addEyes = function () {
		this.eyes.push(new Asteroids.Eye( { pos: [630, 330], ship: this.ship }));
		this.eyes.push(new Asteroids.Eye( { pos: [500, 310], ship: this.ship }));
	}
