(function () {
	...
	GuardCat.prototype.addPaws = function () {
		...
		this.leftPaw = new Asteroids.ShipKiller({ pos: [leftPosX, leftPosY], radius: 5, game: this.game });
		var rightPosX = this.truepos[0] + this.randx + 200;
		var rightPosY = this.truepos[1] + this.randy + 50;
		this.rightPaw = new Asteroids.ShipKiller({ pos: [rightPosX, rightPosY], radius: 6, game: this.game });
