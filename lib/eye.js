(function () {
	...
	Eye.prototype.draw = function (ctx) {
		...
		debugger
		ctx.arc(
		this.pos[0] - this.radius * (2/3) * cosine * ((this.pos[0] - this.ship.pos[0])/ Math.max(this.pos[0], Asteroids.Game.DIM_X - this.pos[0])),
		this.pos[1] - this.radius * (2/3) * sine * ((this.pos[1] - this.ship.pos[1])/Math.max(this.pos[1], Asteroids.Game.DIM_Y - this.pos[1])),
